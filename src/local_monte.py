...
def print_intro() -> None:
    ...
    print("How it Works:")
    print("1. Generate random points in a 2×2 square centered at origin")
    print("2. Count points where x² + y² ≤ 1 (inside the unit circle)")
    print("3. Calculate: π ≈ 4 × (points inside) ÷ (total points)")
...
def update_plot(
    ax, circle, x_in, y_in, x_out, y_out, pi_approx, total
) -> None:
